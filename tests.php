...
$upserv_filters_to_test = array(
	...
	// 'upserv_update_checker'                              => 8, // mixed $update_checker, string $slug, string $type, string $package_file_name, string $vcs_url, string $vcs_branch, mixed $credentials, bool $vcs_self_hosted
